...
$sql = "SELECT j.*, c.c_logo FROM jobs j INNER JOIN company c ON j.c_id = c.c_id";
...
<body>
    ...
    <div class="container-fluid p-0">
        <div style="display: unset!important;" class="owl-carousel header-carousel position-relative">
